...
import com.rb.sss.service.ServDemo_10141Service;
import com.rb.core.rest.ConfigIdentifier;
import com.rb.core.rest.GenericApi;

@Path("/api/v1/employees")
public class ServDemo_10141Controller {

    public static final Logger logger = LoggerFactory.getLogger(ServDemo_10141Controller.class);
	@Inject
	ServDemo_10141Service service;
